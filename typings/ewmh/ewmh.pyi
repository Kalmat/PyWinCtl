...
# AtomValue is not in ewmh, added here as a convenience to tell apart
# an X atom value (as returned by EWMH.GetProperty() and possibly others)
# and a true Any / unknown return value
AtomValue: TypeAlias = Any
...
class EWMH:
    ...
    def _getProperty(self, _type: str, win: Window | None = ...) -> AtomValue | None: ...
    def _setProperty(self, _type: str, data: str | list, win: Window | None = ..., mask: int | None = ...) -> None: ...
    ...
    # Hence using AtomValue as return type
    def getProperty(
